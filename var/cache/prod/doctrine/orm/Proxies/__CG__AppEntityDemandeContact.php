 ...
 */
class DemandeContact extends \App\Entity\DemandeContact implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'dateEnvoi' => [parent::class, 'dateEnvoi', null, 16],
        ...
        'dateEnvoi' => [parent::class, 'dateEnvoi', null, 16],
