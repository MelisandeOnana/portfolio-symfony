...
class get_ServiceLocator_JsQaLu1Service extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.jsQaLu1'])) {
            return $container->privates['.service_locator.jsQaLu1'];
        }

        return $container->privates['.service_locator.jsQaLu1'] = $instance;
    }
}
